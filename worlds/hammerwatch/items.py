...
custom_table: typing.Dict[str, ItemData] = {
    ...
    item_name.key_bonus_archives: ItemData(counter.count(), ItemClassification.useful),
...
castle_button_table: typing.Dict[str, ItemData] = {
    ...
    item_name.btnc_pstart_puzzle: ItemData(counter.count(9), ItemClassification.progression),
    ...
    item_name.btnc_p2_red_spikes: ItemData(counter.count(4), ItemClassification.progression),
    ...
    item_name.btnc_p2_rune_sequence: ItemData(counter.count(2), ItemClassification.progression),
    # item_name.btnc_p2_rune_sequence_part: ItemData(counter.count(), ItemClassification.progression_skip_balancing),
    item_name.btnc_p2_m_stairs: ItemData(counter.count(2), ItemClassification.progression),
    ...
    item_name.btnc_p3_open_bonus: ItemData(counter.count(2), ItemClassification.progression),
    # item_name.btnc_p3_open_bonus_part: ItemData(counter.count(), ItemClassification.progression_skip_balancing),
    item_name.btnc_p3_start: ItemData(counter.count(2), ItemClassification.progression),
    ...
    item_name.btnc_a1_open_m_cache: ItemData(counter.count(2), ItemClassification.progression),
    ...
    item_name.btnc_a2_open_w_exit: ItemData(counter.count(2), ItemClassification.progression),
    ...
    item_name.btnc_a3_tp_m: ItemData(counter.count(2), ItemClassification.progression),
    ...
    item_name.btnc_a3_open_m_stairs: ItemData(counter.count(2), ItemClassification.progression),
    ...
    item_name.btnc_r2_nw_shortcut: ItemData(counter.count(2), ItemClassification.useful),
    ...
    item_name.btnc_r3_bonus: ItemData(counter.count(2), ItemClassification.progression),
    # item_name.btnc_r3_bonus_part: ItemData(counter.count(), ItemClassification.progression_skip_balancing),
    item_name.btnc_r3_passage_end: ItemData(counter.count(2), ItemClassification.progression),
    ...
    item_name.btnc_r3_sw_room: ItemData(counter.count(2), ItemClassification.progression),
    ...
    item_name.btnc_c2_sw_room: ItemData(counter.count(2), ItemClassification.progression),
    ...
    item_name.btnc_c2_tp_spikes: ItemData(counter.count(2), ItemClassification.progression),
    ...
    item_name.btnc_c3_red_spikes: ItemData(counter.count(2), ItemClassification.progression),
    ...
    item_name.btnc_b1_rune_1: ItemData(counter.count(), ItemClassification.progression),
    item_name.btnc_b1_rune_2: ItemData(counter.count(), ItemClassification.progression),
    item_name.btnc_b1_rune_3: ItemData(counter.count(), ItemClassification.progression),
    item_name.btnc_b2_rune_1: ItemData(counter.count(), ItemClassification.progression),
    item_name.btnc_b2_rune_2: ItemData(counter.count(), ItemClassification.progression),
    item_name.btnc_b2_rune_3: ItemData(counter.count(), ItemClassification.progression),
    item_name.btnc_b3_rune_1: ItemData(counter.count(), ItemClassification.progression),
    item_name.btnc_b3_rune_2: ItemData(counter.count(), ItemClassification.progression),
    item_name.btnc_b3_rune_3: ItemData(counter.count(), ItemClassification.progression),
    item_name.btnc_b4_rune_1: ItemData(counter.count(), ItemClassification.progression),
    item_name.btnc_b4_rune_2: ItemData(counter.count(), ItemClassification.progression),
    item_name.btnc_b4_rune_3: ItemData(counter.count(), ItemClassification.progression),
    # item_name.btnc_b1_rune_1_part: ItemData(counter.count(), ItemClassification.progression),
    # item_name.btnc_b1_rune_2_part: ItemData(counter.count(), ItemClassification.progression),
    # item_name.btnc_b1_rune_3_part: ItemData(counter.count(), ItemClassification.progression),
    # item_name.btnc_b2_rune_1_part: ItemData(counter.count(), ItemClassification.progression),
    # item_name.btnc_b2_rune_2_part: ItemData(counter.count(), ItemClassification.progression),
    # item_name.btnc_b2_rune_3_part: ItemData(counter.count(), ItemClassification.progression),
    # item_name.btnc_b3_rune_1_part: ItemData(counter.count(), ItemClassification.progression),
    # item_name.btnc_b3_rune_2_part: ItemData(counter.count(), ItemClassification.progression),
    # item_name.btnc_b3_rune_3_part: ItemData(counter.count(), ItemClassification.progression),
    # item_name.btnc_b4_rune_1_part: ItemData(counter.count(), ItemClassification.progression),
    # item_name.btnc_b4_rune_2_part: ItemData(counter.count(), ItemClassification.progression),
    # item_name.btnc_b4_rune_3_part: ItemData(counter.count(), ItemClassification.progression),
}
...
castle_button_item_counts: typing.Dict[str, int] = {
    ...
    item_name.btnc_p2_red_spikes: 1,
    item_name.btnc_p2_tp_jail: 1,
    item_name.btnc_p2_open_w_jail: 1,
    item_name.btnc_p2_e_save: 1,
    item_name.btnc_p2_puzzle: 1,
    item_name.btnc_p2_tp_w: 1,
    item_name.btnc_p2_rune_sequence: 1,
    item_name.btnc_p2_m_stairs: 1,
    item_name.btnc_p2_shortcut_n: 1,
    item_name.btnc_p2_shortcut_s: 1,
    item_name.btnc_p2_spike_puzzle_r: 1,
    item_name.btnc_p2_spike_puzzle_b: 1,
    item_name.btnc_p2_spike_puzzle_t: 1,
    item_name.btnc_p3_boss_door: 1,
    item_name.btnc_b1_rune_3: 1,
    item_name.btnc_p3_sgate_spikes: 1,
    item_name.btnc_p3_red_spikes: 1,
    item_name.btnc_p3_blue_spikes: 1,
    item_name.btnc_p3_e_passage: 1,
    item_name.btnc_p3_s_spikes: 1,
    item_name.btnc_p3_start: 1,
    item_name.btnc_p3_shop: 1,
    item_name.btnc_p3_bonus_side: 1,
    item_name.btnc_p3_sw_shortcut: 1,
    item_name.btnc_p3_open_n_shortcut: 1,
    item_name.btnc_p3_s_passage: 1,
    item_name.btnc_p3_s_exit_l: 1,
    item_name.btnc_p3_s_exit_r: 1,
    item_name.btnc_b1_pillars: 1,
    item_name.btnc_a1_boss_door: 1,
    item_name.btnc_b2_rune_1: 1,
    item_name.btnc_a1_tp_n: 1,
    item_name.btnc_a1_m_shortcut: 1,
    item_name.btnc_a1_red_spikes: 1,
    item_name.btnc_a1_sw_spikes: 1,
    item_name.btnc_a1_puzzle: 1,
    item_name.btnc_a1_open_se_cache: 1,
    item_name.btnc_a1_open_m_cache: 1,
    item_name.btnc_a1_open_ne_cache: 1,
    item_name.btnc_a1_open_se_wall: 1,
    item_name.btnc_a1_open_se_rune: 1,
    item_name.btnc_b2_rune_2: 1,
    item_name.btnc_a2_pyramid_nw: 1,
    item_name.btnc_a2_bspikes_tp: 1,
    item_name.btnc_a2_open_bonus: 1,
    item_name.btnc_a2_pyramid_sw: 1,
    item_name.btnc_a2_pyramid_se: 1,
    item_name.btnc_a3_pyramid_ne: 1,
    item_name.btnc_a2_tp_ne: 1,
    item_name.btnc_a2_tp_sw: 1,
    item_name.btnc_a2_tp_se: 1,
    item_name.btnc_a2_puzzle: 1,
    item_name.btnc_a2_tp_ne_gates: 1,
    item_name.btnc_a2_open_w_exit: 1,
    item_name.btnc_a2_open_shortcut: 1,
    item_name.btnc_a2_open_se_room_l: 1,
    item_name.btnc_a2_open_se_room_t: 1,
    item_name.btnc_a2_blue_spikes: 1,
    item_name.btnc_b2_rune_3: 1,
    item_name.btnc_a3_tp_m: 1,
    item_name.btnc_a3_bgate_tp: 1,
    item_name.btnc_a3_open_m_stairs: 1,
    item_name.btnc_a3_open_start_n: 1,
    item_name.btnc_a3_open_start_e: 1,
    item_name.btnc_r1_open_w_wall: 1,
    item_name.btnc_r1_open_n_wall: 1,
    item_name.btnc_r1_open_nw_room: 1,
    item_name.btnc_r1_open_m_ledge: 1,
    item_name.btnc_r1_open_l_exit: 1,
    item_name.btnc_r1_open_start_room: 1,
    item_name.btnc_r1_open_e_wall: 1,
    item_name.btnc_r1_open_exits: 1,
    item_name.btnc_r1_puzzle: 1,
    item_name.btnc_r1_ne_shortcut: 1,
    item_name.btnc_r1_w_shortcut: 1,
    item_name.btnc_r1_open_se_room: 1,
    item_name.btnc_b3_rune_2: 1,
    item_name.btnc_b3_rune_1: 1,
    item_name.btnc_r2_open_bs_l: 1,
    item_name.btnc_r2_open_bs_r: 1,
    item_name.btnc_r2_open_fire_t: 1,
    item_name.btnc_r2_open_exit: 1,
    item_name.btnc_r2_open_s_r: 1,
    item_name.btnc_r2_open_fire_b: 1,
    item_name.btnc_r2_open_s_l: 1,
    item_name.btnc_r2_puzzle: 1,
    item_name.btnc_r2_open_puzzle: 1,
    item_name.btnc_r2_nw_shortcut: 1,
    item_name.btnc_r2_open_start: 1,
    item_name.btnc_r2_open_spikes_t: 1,
    item_name.btnc_r2_light_bridge: 1,
    item_name.btnc_r2_open_ne_cache: 1,
    item_name.btnc_r3_boss_door: 1,
    item_name.btnc_b3_rune_3: 1,
    item_name.btnc_r3_passage_room_2: 1,
    item_name.btnc_r3_tp_nw: 1,
    item_name.btnc_r3_open_exit: 1,
    item_name.btnc_r3_open_ne_t: 1,
    item_name.btnc_r3_passage_room_2_spikes: 1,
    item_name.btnc_r3_open_ne_l: 1,
    item_name.btnc_r3_open_s_t: 1,
    item_name.btnc_r3_open_s_r: 1,
    item_name.btnc_r3_open_bs: 1,
    item_name.btnc_r3_simon: 1,
    item_name.btnc_r3_bonus_bridge: 1,
    item_name.btnc_r3_bonus: 1,
    item_name.btnc_r3_passage_end: 1,
    item_name.btnc_r3_passage_room_1: 1,
    item_name.btnc_r3_tp_ne_t: 1,
    item_name.btnc_r3_tp_ne_b: 1,
    item_name.btnc_r3_sw_room: 1,
    item_name.btnc_c1_n_spikes: 1,
    item_name.btnc_c1_red_spikes: 1,
    item_name.btnc_c1_red_spike_turrets: 1,
    item_name.btnc_c1_red_flame_turrets: 1,
    item_name.btnc_c1_s_shortcut: 1,
    item_name.btnc_pstart_puzzle: 1,
    item_name.btnc_pstart_bridge: 1,
    item_name.btnc_b4_rune_2: 1,
    item_name.btnc_b4_rune_1: 1,
    item_name.btnc_c2_sw_room: 1,
    item_name.btnc_c2_n_shops: 1,
    item_name.btnc_c2_w_shortcut: 1,
    item_name.btnc_c2_puzzle: 1,
    item_name.btnc_c2_bonus: 1,
    item_name.btnc_c2_tp_spikes: 1,
    item_name.btnc_c2_n_room: 1,
    item_name.btnc_c2_n_red_flame_turret_on: 1,
    item_name.btnc_c2_blue_spike_turret: 1,
    item_name.btnc_c2_open_puzzle: 1,
    item_name.btnc_c2_e_shop: 1,
    item_name.btnc_c2_s_red_flame_turret: 1,
    item_name.btnc_c2_s_shortcut: 1,
    item_name.btnc_b4_rune_3: 1,
    item_name.btnc_c3_e_shortcut: 1,
    item_name.btnc_c3_sw_room: 1,
    item_name.btnc_c3_red_spikes: 1,
    item_name.btnc_c3_blue_fire_turrets_on: 1,
    item_name.btnc_c3_tp_m: 1,
    item_name.btnc_c3_red_spike_turrets: 1,
    item_name.btnc_c3_tp_se: 1,
    item_name.btnc_c3_open_w_room: 1,
    item_name.btnc_n1_cache_n: 1,
    item_name.btnc_n1_cache_ne: 1,
    item_name.btnc_n1_hall_top: 1,
    item_name.btnc_n1_hall_bottom: 1,
    item_name.btnc_n2_open_se_room: 1,
    item_name.btnc_n2_open_ne_room: 1,
    item_name.btnc_n2_open_exit: 1,
    item_name.btnc_p3_nw_room: 1,
    item_name.btnc_p3_portal: 1,
    item_name.btnc_r2_open_spikes_l: 1,
    item_name.btnc_r3_passage: 1,
    item_name.btnc_c1_sw_exit: 1,
    item_name.btnc_c3_open_s_hall: 1,
    item_name.btnc_p3_open_bonus: 1,
    item_name.btnc_a3_open_knife: 1,
    item_name.btnc_a3_open_knife_2: 1,
    item_name.btnc_r3_simon_room: 1,
...
temple_button_item_counts: typing.Dict[str, int] = {
    ...
    item_name.btn_c2_red: 1,
    item_name.btn_c2_green: 1,
    item_name.btn_c2_bridges: 1,
    item_name.btn_c2_s_bridge: 1,
    item_name.btn_c2_pumps: 1,
    item_name.btn_c2_puzzle: 1,
    item_name.btn_c1_blue: 1,
    item_name.btn_c1_red: 1,
    item_name.btn_c1_green: 1,
    item_name.btn_c1_puzzle_e: 1,
    item_name.btn_c1_puzzle_w: 1,
    item_name.btn_c1_tunnel: 1,
    item_name.btn_b1_bridge: 1,
    item_name.btn_p_puzzle: 1,
    item_name.btn_t1_puzzle_e: 1,
    item_name.btn_t1_puzzle_w: 1,
    item_name.btn_t1_jail_n: 1,
    item_name.btn_t1_jail_e: 1,
    item_name.btn_t1_telarian: 1,
    item_name.btn_t1_guard: 1,
    item_name.btn_t1_hall: 1,
    item_name.btn_t1_runway: 1,
    item_name.btn_t2_blue: 1,
    item_name.btn_t2_puzzle_n: 1,
    item_name.btn_t2_puzzle_e: 1,
    item_name.btn_t2_puzzle_s: 1,
    item_name.btn_t2_puzzle_w: 1,
    item_name.btn_t2_jones_hall_back: 1,
    item_name.btn_t2_nw_gate: 1,
    item_name.btn_t2_jones_hall: 1,
    item_name.btn_t2_t3_gate_e: 1,
    item_name.btn_t2_t3_gate_w: 1,
    item_name.btn_t2_boulder_passage: 1,
    item_name.btn_t2_ice_gate_w: 1,
    item_name.btn_t2_ice_gate_e: 1,
    item_name.btn_t2_boulder_room: 1,
    item_name.btn_t2_jail_w: 1,
    item_name.btn_t2_jail_e: 1,
    item_name.btn_t2_s_spikes: 1,
    item_name.btn_t2_s_gate_shortcut: 1,
    item_name.btn_t2_s_gate_hall: 1,
    item_name.btn_t2_jail_s: 1,
    item_name.btn_t2_portal_gate: 1,
    item_name.btn_t3_puzzle: 1,
    item_name.btn_t3_fall_1: 1,
    item_name.btn_t3_fall_2: 1,
    item_name.btn_t3_fall_3: 1,
    item_name.btn_t3_pillars: 1,
    item_name.btn_t3_gate_s: 1,
    item_name.btn_pof_puzzle: 1,
    item_name.btn_pof_1_walls_s: 1,
    item_name.btn_pof_1_exit: 1,
    item_name.btn_pof_2_puzzle: 1,
    item_name.btn_pof_2_exit: 1,
    item_name.btn_pof_3_start: 1,
