...
hammerwatch_options: typing.Dict[str, type(Option)] = {
    OptionNames.goal: Goal,
    OptionNames.planks_required_count: PlanksRequiredCount,
    OptionNames.extra_plank_percent: ExtraPlankPercent,
    OptionNames.difficulty: Difficulty,
    OptionNames.exit_randomization: ExitRandomization,
    OptionNames.er_act_range: ERActRange,
    OptionNames.random_start_exit: StartExit,
    OptionNames.random_start_exit_act: StartExitAct,
    OptionNames.gate_shuffle: GateShuffle,
    OptionNames.shop_shuffle: ShuffleShops,
    OptionNames.shop_upgrade_category_shuffle: ShopUpgradeCategoryShuffle,
    # OptionNames.shop_upgrade_level_shuffle: ShopUpgradeLevelShuffle,
    OptionNames.shop_cost_min: ShopCostRandoMin,
    OptionNames.shop_cost_max: ShopCostRandoMax,
    OptionNames.enemy_shuffle: EnemyShuffle,
    OptionNames.enemy_shuffle_act_range: EnemyShuffleBalancing,
    OptionNames.bonus_behavior: BonusChestLocationBehavior,
    OptionNames.randomize_bonus_keys: RandomizeBonusKeys,
    OptionNames.remove_lives: RemoveExtraLives,
    OptionNames.randomize_recovery_items: RandomizeRecoveryItems,
    OptionNames.randomize_secrets: RandomizeSecrets,
    OptionNames.randomize_puzzles: RandomizePuzzles,
    OptionNames.randomize_enemy_loot: RandomizeEnemyLoot,
    OptionNames.open_castle: OpenCastle,
    OptionNames.act_specific_keys: ActSpecificKeys,
    OptionNames.extra_keys_percent: ExtraKeysPercent,
    OptionNames.big_bronze_key_percent: BigBronzeKeyPercent,
    OptionNames.shortcut_teleporter: ShortcutTeleporter,
    OptionNames.portal_accessibility: PortalAccessibility,
    OptionNames.no_sunbeam_damage: NoSunbeamDamage,
    OptionNames.treasure_shuffle: TreasureShuffle,
    # OptionNames.consumables_vendor_locations: ConsumableMerchantChecks,
    OptionNames.pan_fragments: PanFragments,
    OptionNames.lever_fragments: LeverFragments,
    OptionNames.pickaxe_fragments: PickaxeFragments,
    OptionNames.trap_item_percent: TrapItemPercentage,
    OptionNames.starting_life_count: StartingLifeCount,
    OptionNames.death_link: DeathLink
}
