...
castle_button_locations: typing.Dict[str, LocationData] = {
    castle_location_names.btn_p1_boss: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p1_boss_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p1_boss_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p1_boss_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p1_boss_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p1_floor: LocationData(counter.count(2), LocationClassification.Button),
    castle_location_names.btn_p2_boss: LocationData(counter.count(6), LocationClassification.Button),
    castle_location_names.btn_p2_boss_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p2_boss_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p2_boss_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p2_boss_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p2_floor_spike_puzzle_e_1: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_floor_spike_puzzle_n_3: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_floor_spike_puzzle_n_2: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_floor_spike_puzzle_e_2: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_floor_spike_puzzle_n_1: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_floor_spike_puzzle_e_3: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_floor_spike_puzzle_s_3: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_floor_spike_puzzle_s_2: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_floor_spike_puzzle_s_1: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_floor_red: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_floor_tp_item_2: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_floor_tp_item_1: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_floor_e_save: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_puzzle: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_rune_puzzle: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_rune_puzzle_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p2_rune_sequence: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_rune_sequence_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p2_rune_puzzle_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p2_rune_sequence_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p2_rune_puzzle_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p2_rune_sequence_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p2_rune_puzzle_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p2_rune_sequence_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p2_wall_from_p1: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_wall_shortcut_1: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p2_wall_shortcut_2: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_boss_door: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_boss_s: LocationData(counter.count(2), LocationClassification.Button),
    castle_location_names.btn_p3_boss_s_3: LocationData(counter.count(5), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p3_boss_s_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p3_boss_s_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p3_boss_s_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p3_floor: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_floor_red: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_floor_blue: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_floor_sw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_floor_arrow_hall: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_rune_bonus_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p3_rune_bonus_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p3_rune_bonus_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p3_rune_bonus_6: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p3_rune_bonus_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p3_rune_bonus_5: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p3_rune_bonus_7: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p3_rune_bonus_8: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p3_rune_bonus_9: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_p3_wall_bonus_nw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_wall_start: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_wall_start_n: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_wall_bonus: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_wall_bonus_ne: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_wall_sw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_wall_bonus_w_1: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_wall_bonus_w_2: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_wall_bonus_s: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_wall_bonus_se: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_wall_secret_arrow_hall: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_wall_boss_door: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_wall_to_p1_s: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_b1_1: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_b1_2: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a1_boss_door: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a1_boss: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a1_boss_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a1_boss_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a1_boss_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a1_boss_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a1_floor_tp_n: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a1_floor_shortcut: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a1_floor_red: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a1_floor_sw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a1_puzzle: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a1_rune: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a1_rune_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a1_rune_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a1_rune_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a1_rune_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a1_wall_m_cache: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a1_wall_red_spikes: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a1_wall_start: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a1_wall_se: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_boss: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_boss_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a2_boss_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a2_boss_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a2_boss_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a2_floor_pyramid_nw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_floor_tp_n: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_floor_pyramid_ne: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_floor_pyramid_sw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_floor_pyramid_se: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_floor_pyramid_m: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_floor_secret_e: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_floor_sw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_floor_tp_se: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_puzzle: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_rune: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_rune_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a2_rune_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a2_rune_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a2_rune_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a2_wall_nw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_wall_sw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_wall_se: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a2_wall_e: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_n2_floor_blue: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a3_boss: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a3_boss_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a3_boss_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a3_boss_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a3_boss_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_a3_floor_knife_1: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a3_floor_knife_3: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a3_floor_knife_4: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a3_floor_knife_5: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a3_floor_knife_2: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a3_floor_tp_m: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a3_floor_stairs_in_wall: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a3_wall_knife_1: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a3_wall_knife_2: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a3_wall_from_a2: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a3_wall_start: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_a3_wall_end: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r1_floor_nw_hidden: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r1_floor_ne: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r1_floor_nw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r1_floor_e: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r1_floor_w_s: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r1_floor_w_shop: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r1_floor_se: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r1_floor_exit: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r1_puzzle: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r1_wall_ne: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r1_wall_w: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r1_wall_se: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_boss_n: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_boss_e: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_boss_n_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r2_boss_n_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r2_boss_n_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r2_boss_n_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r2_boss_e_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r2_boss_e_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r2_boss_e_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r2_boss_e_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r2_floor_nw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_floor_boss_rune: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_floor_ne: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_floor_gate_w: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_floor_gate_s: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_floor_e: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_floor_sw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_puzzle: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_rune: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_rune_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r2_rune_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r2_rune_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r2_rune_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r2_wall_nw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_wall_start: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_wall_spike_island_n: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_wall_spike_island_s: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_wall_ne: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_boss_door: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_boss: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_boss_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r3_boss_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r3_boss_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r3_boss_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r3_floor_passage: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_floor_passage_end: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_floor_gate_nw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_floor_ne: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_floor_passage_room_2: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_floor_ne_room: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_floor_s_room: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_floor_s: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_floor_se: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_floor_simon: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_rune: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_rune_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r3_simon: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_simon_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r3_rune_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r3_simon_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r3_rune_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r3_simon_5: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r3_rune_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r3_simon_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r3_simon_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r3_simon_6: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_r3_wall_passage_room_2: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_wall_passage_room_1: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_wall_ne_2: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_wall_ne_1: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_wall_seq_n: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_wall_seq_ne: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_wall_sw_gate: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_wall_seq_w: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_wall_seq_m: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_wall_seq_se: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c1_floor_n: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c1_floor_red: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c1_wall_red: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c1_wall_ledge: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c1_wall_s_gate: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_pstart_puzzle: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_pstart_rune: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_pstart_rune_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_pstart_rune_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_pstart_rune_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_pstart_rune_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_boss_w: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c2_boss_e: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c2_boss_w_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_boss_w_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_boss_w_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_boss_w_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_boss_e_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_boss_e_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_boss_e_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_boss_e_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_floor_sw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c2_floor_t_hall: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c2_floor_w: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c2_puzzle: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c2_rune_bonus: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c2_rune_bonus_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_rune: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c2_rune_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_rune_bonus_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_rune_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_rune_bonus_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_rune_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_rune_bonus_8: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_rune_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c2_rune_bonus_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    ...
    castle_location_names.btn_c2_wall_seq_nw: LocationData(counter.count(10), LocationClassification.Buttoninsanity),
    ...
    castle_location_names.btn_c2_wall_e_shop: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c2_wall_red_s: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c2_wall_s_save: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c3_boss: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c3_boss_1: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c3_boss_3: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c3_boss_2: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c3_boss_4: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c3_floor: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c3_rune: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c3_rune_s: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c3_rune_se: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c3_rune_w: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c3_rune_e: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c3_rune_n: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c3_rune_ne: LocationData(counter.count(), LocationClassification.Buttoninsanity),
    castle_location_names.btn_c3_wall_red: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c3_wall_blue: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c3_wall_w: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c3_wall_shop: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c3_wall_fire_floor: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c3_wall_se_hidden: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_n1_panel_n: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_n1_panel_e_1: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_n1_panel_e_2: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_n1_panel_s: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_n2_panel_n: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_n2_panel_se: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_n2_panel_ne: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_wall_start_nw: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_p3_rune_bonus: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r2_floor_sw_hidden: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_r3_floor_sw_gate: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c1_wall_portal: LocationData(counter.count(), LocationClassification.Button),
    castle_location_names.btn_c3_wall_sw_hidden: LocationData(counter.count(), LocationClassification.Button),
...
castle_event_buttons: typing.Dict[str, str] = {
    ...
    castle_location_names.btn_p1_boss: item_name.btnc_b1_boss,
    castle_location_names.btn_p2_boss: item_name.btnc_b1_boss,
    castle_location_names.btn_p3_boss_s: item_name.btnc_b1_boss,
    castle_location_names.btn_a1_boss: item_name.btnc_b2_boss,
    castle_location_names.btn_a2_boss: item_name.btnc_b2_boss,
    castle_location_names.btn_a3_boss: item_name.btnc_b2_boss,
    castle_location_names.btn_r2_boss_e: item_name.btnc_b3_boss,
    castle_location_names.btn_r2_boss_n: item_name.btnc_b3_boss,
    castle_location_names.btn_r3_boss: item_name.btnc_b3_boss,
    castle_location_names.btn_c2_boss_e: item_name.btnc_b4_boss,
    castle_location_names.btn_c2_boss_w: item_name.btnc_b4_boss,
    castle_location_names.btn_c3_boss: item_name.btnc_b4_boss,
}
...
castle_button_items: typing.Dict[str, str] = {
    castle_location_names.btn_p1_boss: item_name.btnc_b1_boss,
    castle_location_names.btn_p1_boss_1: item_name.btnc_b1_boss_part,
    castle_location_names.btn_p1_boss_2: item_name.btnc_b1_boss_part,
    castle_location_names.btn_p1_boss_3: item_name.btnc_b1_boss_part,
    castle_location_names.btn_p1_boss_4: item_name.btnc_b1_boss_part,
    castle_location_names.btn_p1_floor: item_name.btnc_p1_floor,
    castle_location_names.btn_p2_boss: item_name.btnc_b1_boss,
    castle_location_names.btn_p2_boss_2: item_name.btnc_b1_boss_part,
    ...
    castle_location_names.btn_p3_boss_s: item_name.btnc_b1_boss,
    castle_location_names.btn_p3_boss_s_3: item_name.btnc_b1_boss_part,
    castle_location_names.btn_p3_boss_s_4: item_name.btnc_b1_boss_part,
    castle_location_names.btn_p3_boss_s_1: item_name.btnc_b1_boss_part,
    castle_location_names.btn_p3_boss_s_2: item_name.btnc_b1_boss_part,
    ...
    castle_location_names.btn_a1_boss: item_name.btnc_b2_boss,
    castle_location_names.btn_a1_boss_2: item_name.btnc_b2_boss_part,
    castle_location_names.btn_a1_boss_1: item_name.btnc_b2_boss_part,
    castle_location_names.btn_a1_boss_3: item_name.btnc_b2_boss_part,
    castle_location_names.btn_a1_boss_4: item_name.btnc_b2_boss_part,
    ...
    castle_location_names.btn_a2_boss: item_name.btnc_b2_boss,
    castle_location_names.btn_a2_boss_2: item_name.btnc_b2_boss_part,
    castle_location_names.btn_a2_boss_1: item_name.btnc_b2_boss_part,
    castle_location_names.btn_a2_boss_3: item_name.btnc_b2_boss_part,
    castle_location_names.btn_a2_boss_4: item_name.btnc_b2_boss_part,
    ...
    castle_location_names.btn_n2_floor_blue: item_name.btnc_a2_blue_spikes,
    castle_location_names.btn_a3_boss: item_name.btnc_b2_boss,
    castle_location_names.btn_a3_boss_1: item_name.btnc_b2_boss_part,
    castle_location_names.btn_a3_boss_3: item_name.btnc_b2_boss_part,
    castle_location_names.btn_a3_boss_2: item_name.btnc_b2_boss_part,
    castle_location_names.btn_a3_boss_4: item_name.btnc_b2_boss_part,
    ...
    castle_location_names.btn_r2_boss_n: item_name.btnc_b3_boss,
    castle_location_names.btn_r2_boss_e: item_name.btnc_b3_boss,
    castle_location_names.btn_r2_boss_n_2: item_name.btnc_b3_boss_part,
    castle_location_names.btn_r2_boss_n_1: item_name.btnc_b3_boss_part,
    castle_location_names.btn_r2_boss_n_4: item_name.btnc_b3_boss_part,
    castle_location_names.btn_r2_boss_n_3: item_name.btnc_b3_boss_part,
    castle_location_names.btn_r2_boss_e_2: item_name.btnc_b3_boss_part,
    castle_location_names.btn_r2_boss_e_1: item_name.btnc_b3_boss_part,
    castle_location_names.btn_r2_boss_e_3: item_name.btnc_b3_boss_part,
    castle_location_names.btn_r2_boss_e_4: item_name.btnc_b3_boss_part,
    ...
    castle_location_names.btn_r3_boss: item_name.btnc_b3_boss,
    castle_location_names.btn_r3_boss_3: item_name.btnc_b3_boss_part,
    castle_location_names.btn_r3_boss_4: item_name.btnc_b3_boss_part,
    castle_location_names.btn_r3_boss_1: item_name.btnc_b3_boss_part,
    castle_location_names.btn_r3_boss_2: item_name.btnc_b3_boss_part,
    ...
    castle_location_names.btn_c2_boss_w: item_name.btnc_b4_boss,
    castle_location_names.btn_c2_boss_e: item_name.btnc_b4_boss,
    castle_location_names.btn_c2_boss_w_1: item_name.btnc_b4_boss_part,
    castle_location_names.btn_c2_boss_w_3: item_name.btnc_b4_boss_part,
    castle_location_names.btn_c2_boss_w_2: item_name.btnc_b4_boss_part,
    castle_location_names.btn_c2_boss_w_4: item_name.btnc_b4_boss_part,
    castle_location_names.btn_c2_boss_e_2: item_name.btnc_b4_boss_part,
    castle_location_names.btn_c2_boss_e_1: item_name.btnc_b4_boss_part,
    castle_location_names.btn_c2_boss_e_3: item_name.btnc_b4_boss_part,
    castle_location_names.btn_c2_boss_e_4: item_name.btnc_b4_boss_part,
    ...
    castle_location_names.btn_c3_boss: item_name.btnc_b4_boss,
    castle_location_names.btn_c3_boss_1: item_name.btnc_b4_boss_part,
    castle_location_names.btn_c3_boss_3: item_name.btnc_b4_boss_part,
    castle_location_names.btn_c3_boss_2: item_name.btnc_b4_boss_part,
    castle_location_names.btn_c3_boss_4: item_name.btnc_b4_boss_part,
...
def setup_locations(world: "HammerwatchWorld", hw_map: Campaign):
    ...
    if get_buttonsanity_insanity(world):
        ...
        for loc, itm in map_button_items.items():
            if button_locations[loc].classification == LocationClassification.Buttoninsanity:
                continue
            if itm not in button_items:
                button_items[itm] = 0
            button_items[itm] += 1
    ...
    for name, data in hw_map_locations.items():
        if data.classification == LocationClassification.Bonus:
            ...
            continue
        if data.classification != LocationClassification.Recovery or world.options.randomize_recovery_items.value:
