...
castle_pickup_locations: typing.Dict[str, LocationData] = {
    ...
    castle_location_names.p1_entrance_secret: LocationData(counter.count(), LocType.Secret),
    ...
    castle_location_names.p3_secret_secret: LocationData(counter.count(), LocType.Recovery | LocType.Secret),
    ...
    castle_location_names.p3_by_m_shop_1: LocationData(counter.count(), LocType.Secret),
    castle_location_names.p3_by_m_shop_2: LocationData(counter.count(), LocType.Secret),
    ...
    castle_location_names.n1_room2_n_secret_room: LocationData(counter.count(), LocType.Secret),
    ...
    castle_location_names.a3_secret_shop: LocationData(counter.count(), LocType.Secret),
    ...
    castle_location_names.c3_easter_egg: LocationData(counter.count(), LocType.Secret),
...
castle_button_locations: typing.Dict[str, LocationData] = {
    ...
    castle_location_names.btn_p2_floor_tp_item_2: LocationData(counter.count(), LocType.Button | LocType.Secret),
    castle_location_names.btn_p2_floor_tp_item_1: LocationData(counter.count(), LocType.Button | LocType.Secret),
    castle_location_names.btn_p2_floor_e_save: LocationData(counter.count(), LocType.Button),
    castle_location_names.btn_p2_puzzle: LocationData(counter.count(), LocType.Button | LocType.Puzzle | LocType.Secret),
    castle_location_names.btn_p2_rune_puzzle: LocationData(counter.count(), LocType.Button | LocType.Secret),
    castle_location_names.btn_p2_rune_puzzle_2: LocationData(counter.count(), LocType.Buttoninsanity | LocType.Secret),
    ...
    castle_location_names.btn_p2_rune_puzzle_1: LocationData(counter.count(), LocType.Buttoninsanity | LocType.Secret),
    castle_location_names.btn_p2_rune_sequence_2: LocationData(counter.count(), LocType.Buttoninsanity),
    castle_location_names.btn_p2_rune_puzzle_4: LocationData(counter.count(), LocType.Buttoninsanity | LocType.Secret),
    castle_location_names.btn_p2_rune_sequence_4: LocationData(counter.count(), LocType.Buttoninsanity),
    castle_location_names.btn_p2_rune_puzzle_3: LocationData(counter.count(), LocType.Buttoninsanity | LocType.Secret),
    ...
    castle_location_names.btn_a1_puzzle: LocationData(counter.count(), LocType.Button | LocType.Puzzle | LocType.Secret),
    ...
    castle_location_names.btn_a2_floor_secret_e: LocationData(counter.count(), LocType.Button | LocType.Secret),
    ...
    castle_location_names.btn_a2_puzzle: LocationData(counter.count(), LocType.Button | LocType.Puzzle | LocType.Secret),
    ...
    castle_location_names.btn_r2_rune: LocationData(counter.count(), LocType.Button | LocType.Secret),
    castle_location_names.btn_r2_rune_1: LocationData(counter.count(), LocType.Buttoninsanity | LocType.Secret),
    castle_location_names.btn_r2_rune_2: LocationData(counter.count(), LocType.Buttoninsanity | LocType.Secret),
    castle_location_names.btn_r2_rune_3: LocationData(counter.count(), LocType.Buttoninsanity | LocType.Secret),
    castle_location_names.btn_r2_rune_4: LocationData(counter.count(), LocType.Buttoninsanity | LocType.Secret),
    ...
    castle_location_names.btn_r3_floor_passage: LocationData(counter.count(), LocType.Button | LocType.Secret),
    ...
    castle_location_names.btn_p3_wall_start_nw: LocationData(counter.count(), LocType.Button | LocType.Secret),
    ...
    castle_location_names.btn_r3_floor_sw_gate: LocationData(counter.count(), LocType.Button | LocType.Secret),
